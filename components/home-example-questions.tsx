...
export const EXAMPLES = [
  ...
  },
  {
    ...
    questions: [
      ...
      "Find me design inspiration for dashboards",
  ...
  },
  {
    ...
    label: "Create",
    questions: [
      "Generate a modern landing page layout",
      "Create a REST API with authentication",
      "Design a neumorphic button in CSS",
      "Write a blog post outline about TypeScript",
    ],
  },
  {
    key: "learn",
